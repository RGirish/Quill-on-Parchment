...
$sql="SELECT title,id,url,author,DATE_FORMAT(date, '%D %M %Y'),aid,leadline,language FROM tbl_status WHERE type='s' AND status='a' AND genre='st' AND language='e' LIMIT $top,$bottom;";

if(isset($_GET['sort']))
{
if($_GET['sort']=="d")
{
$sql="SELECT title,id,url,author,DATE_FORMAT(date, '%D %M %Y'),aid,leadline,language FROM tbl_status WHERE type='s' AND status='a' AND genre='st' AND language='e' ORDER BY date DESC LIMIT $top,$bottom;";
}
else if($_GET['sort']=="a")
{
$sql="SELECT title,id,url,author,DATE_FORMAT(date, '%D %M %Y'),aid,leadline,language FROM tbl_status WHERE type='s' AND status='a' AND genre='st' AND language='e' ORDER BY author LIMIT $top,$bottom;";
}
else if($_GET['sort']=="t")
{
$sql="SELECT title,id,url,author,DATE_FORMAT(date, '%D %M %Y'),aid,leadline,language FROM tbl_status WHERE type='s' AND status='a' AND genre='st' AND language='e' ORDER BY title LIMIT $top,$bottom;";
}
else if($_GET['sort']=="l")
{
$sql="SELECT title,id,url,author,DATE_FORMAT(date, '%D %M %Y'),aid,leadline,language FROM tbl_status WHERE type='s' AND status='a' AND genre='st' AND language='e' ORDER BY likes DESC LIMIT $top,$bottom;";
}
else if($_GET['sort']=="v")
{
$sql="SELECT title,id,url,author,DATE_FORMAT(date, '%D %M %Y'),aid,leadline,language FROM tbl_status WHERE type='s' AND status='a' AND genre='st' AND language='e' ORDER BY views DESC LIMIT $top,$bottom;";
}
}
