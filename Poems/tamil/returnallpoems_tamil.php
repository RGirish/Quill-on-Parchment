...
$sql="SELECT title,id,url,author,DATE_FORMAT(date, '%D %M %Y'),aid,leadline FROM tbl_status WHERE type='p' AND status='a' AND language='t' ORDER BY date DESC LIMIT $top,$bottom;";
...
echo "<div style=\"padding-left:130px;text-align:left;position:relative;\">";
echo "<a href=\"../../" . $row[2] .  "\"><font style=\"font-family:Hand;font-size:1.4em;color:#fff;\"><u>" . $row[0] .  "</u></font></a>";
...
echo "<h1 style=\"color:#fff;text-align:left;font-family:Hand;font-size:1em\">\"" . $row[6] . "\"</h1>";
